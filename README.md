...
- **沉浸式狼人杀**：活动会进入九席圆桌会场，由独立系统法官按天黑、狼人、预言家、女巫、天亮、发言与投票的顺序主持；上帝观察者可见完整夜间演出，参赛居民只知道自身应知信息。
- **三声道声音**：小镇音乐、环境声和操作音效可分别调节；狼人杀会场会随昼夜与投票阶段切换氛围，浏览器首次播放需点击一次声音按钮授权。
...
刀人、查验、用药与投票都会以桌游演出和事件记录呈现，不表示真实伤害。观察模式会显示法官视角的夜间目标与动作；居民参赛视角仍受身份和阶段权限限制。演出可切换 `1×`、`2×` 或跳过，跳过只影响画面节奏，不改变后台结算。桌面端采用会场与记录双栏，手机端自动切成纵向圆桌和折叠记录。
...
- **声音**：点击底部声音按钮开启浏览器音频，可分别调整音乐、环境音和音效；快捷键 `M` 一键静音或恢复。
